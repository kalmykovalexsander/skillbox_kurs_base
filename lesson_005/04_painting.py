...
sd.background_color = (1, 10, 14)
# sd.background_color = (109, 147, 176)
...
root_point = ((sd.get_point(950, 10),  pt_building.building_size [1] / 2 - sd.random_number(10, 30)),
              (sd.get_point(200, 20),  pt_building.building_size [1] / 2 - sd.random_number(10, 30)))


def my_clear_screen(color):
    # print(color)

    screen_point = (sd.get_point(0, 0),
                    sd.get_point(0, sd.resolution[0]),
...
def change_part_day():
    ...
    my_clear_screen(background_color)
